        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('store.shows') }}" enctype="multipart/form-data">
                        <!-- Email input -->
                        @csrf
                        ...
                        <div class="form-outline mb-4 mt-4">
                            ...
                            <select name="genres" class="form-select  form-control" aria-label="Default select example">
                            ...
                            @if ($errors->has('genres'))
                                <p class="alert alert-danger">{{ $errors->first('genres') }}</p>
                            @endif
                        </div>
                        <div class="form-outline mb-4 mt-4">
